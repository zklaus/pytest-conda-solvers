# pytest-conda-solvers documentation build configuration file, created by
...
project = 'pytest-conda-solvers'
copyright = '2024, conda contributors'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-conda-solvers Documentation',
     [author], 1)
]
